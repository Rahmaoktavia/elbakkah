...
@section('title', 'Tambah Inventaris Perlengkapan')
...
<div class="card shadow-sm">
    ...
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <h4 class="fw-bold text-dark mb-0">Tambah Inventaris Perlengkapan</h4>
    </div>

    <!-- Body -->
    <div class="card-body">
        <form action="{{ route('dashboard.inventaris.store') }}" method="POST">
            @csrf
            ...
            <div class="mb-3">
                ...
                <input type="text" class="form-control @error('nama_perlengkapan') is-invalid @enderror"
                       ...
                       placeholder="Masukkan nama perlengkapan" value="{{ old('nama_perlengkapan') }}">
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('jumlah_total') is-invalid @enderror"
                       ...
                       placeholder="Masukkan jumlah total" value="{{ old('jumlah_total') }}">
                @error('jumlah_total')
                    <div class="invalid-feedback">{{ $message }}</div>
                @enderror
            </div>
            ...
            <div class="mb-3">
                ...
                <input type="number" class="form-control @error('jumlah_tersedia') is-invalid @enderror"
                       ...
                       placeholder="Masukkan jumlah tersedia" value="{{ old('jumlah_tersedia') }}">

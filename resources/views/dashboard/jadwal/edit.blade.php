...
<div class="card shadow-sm">
    ...
    <div class="card-header bg-white d-flex justify-content-between align-items-center">
        <h4 class="fw-bold text-dark mb-0">Edit Jadwal Keberangkatan</h4>
    </div>

    <!-- Body -->
    <div class="card-body">
        <form action="{{ route('dashboard.jadwal.update', $jadwal->id) }}" method="POST">
            @csrf
            @method('PUT')
            ...
            <div class="mb-3">
                ...
                <input type="date" class="form-control @error('tanggal_berangkat') is-invalid @enderror"
                       ...
                       value="{{ old('tanggal_berangkat', $jadwal->tanggal_berangkat) }}">

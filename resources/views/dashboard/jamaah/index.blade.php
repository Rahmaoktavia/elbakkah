...
<div class="card shadow-sm">
    <div class="card-header bg-white">
        <h4 class="fw-bold text-dark mb-3">Data Jamaah</h4>

        <div class="d-flex justify-content-between align-items-center">
            <div class="d-flex">

                <a href="{{ route('dashboard.jamaah.cetak_pdf') }}" target="_blank" class="btn btn-outline-danger d-flex align-items-center justify-content-center">
                    <i class='bx bxs-file-pdf fs-5'></i>
                </a>
            </div>

            <form class="d-flex" method="GET" action="{{ route('dashboard.jamaah.index') }}" style="max-width: 300px; width: 100%;">
    ...
    <div class="card-body">
                ...
                <tr>
                    ...
                    <td class="text-nowrap text-center">
                        <div class="btn-group" role="group">
                            <a href="{{ route('dashboard.jamaah.show', $jamaah->id) }}" class="btn btn-success btn-sm me-1" title="Lihat Detail">
                                <i class='bx bx-show'></i>
                            </a>
                            <a href="{{ route('dashboard.jamaah.edit', $jamaah->id) }}" class="btn btn-warning btn-sm me-1" title="Edit Data">
                                <i class='bx bx-edit'></i>
                            </a>
                            <form action="{{ route('dashboard.jamaah.destroy', $jamaah->id) }}" method="POST" class="d-inline form-delete">
                                @csrf
                                @method('DELETE')
        ...
        <div class="d-flex justify-content-center mt-4">
            {{ $jamaahs->appends(request()->query())->links('pagination::bootstrap-4') }}
        </div>
    </div>
</div>
@endsection
